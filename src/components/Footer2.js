...
function Footer() {
  return (
    <div className={classes.container}>
      ...
      <Row>
        <Col className={classes.pink}></Col>
        <Col className={classes.yellow}></Col>
        <Col className={classes.purple}></Col>
        <Col className={classes.orange}></Col>
        <Col className={classes.blue}></Col>
        <Col className={classes.grBlue}>
          <p className={classes.letter}>B</p>
        </Col>
        <Col className={classes.red}>
          <p className={classes.letter}>L</p>
        </Col>
        <Col className={classes.green}>
          <p className={classes.letter}>O</p>
        </Col>
        <Col className={classes.gray}>
